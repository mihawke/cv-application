...
function App() {
  ...
  const getResume = () => {
    return <div className='resumeContent'>
      <section>
      ...
      <section>      <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '20px' }}>
  ...
  return (
    <>
      <div className='formContainer'>
        <PersonalInfo onUpdate={handlePersonalData} visibility={visible} onClose={() => setVisible('none')} data={formData.personalData}></PersonalInfo>
